...
public class DescribingAnnotation extends WebAnnotation implements Annotation<WebAnnotation> {
    ...
    /**
     * Creates a description annotation from the supplied annotation ID and a list of targets.
     *
     * @param aID An annotation ID
     * @param aTargetList A list of annotation targets
     */
    public DescribingAnnotation(final String aID, final List<Target> aTargetList) {
    ...
    /**
     * Creates a description annotation from the supplied annotation ID and an array of targets.
     *
     * @param aID An annotation ID
     * @param aTargetArray An array of annotation targets
     */
    public DescribingAnnotation(final String aID, final Target... aTargetArray) {
    ...
    public final DescribingAnnotation setMotivation(final Motivation aMotivation) {
        if (!Purpose.DESCRIBING.toString().equalsIgnoreCase(aMotivation.toString())) {
            throw new IllegalArgumentException(LOGGER.getMessage(MessageCodes.JPA_038,
                    DescribingAnnotation.class.getSimpleName(), Purpose.DESCRIBING, aMotivation));
        }
