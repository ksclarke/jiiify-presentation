...
final class BehaviorConstants {
    ...
    /**
     * The auto-advance behavior constant.
     */
    static final String AUTO_ADVANCE = "auto-advance";

    /**
     * The continuous behavior constant.
     */
    static final String CONTINUOUS = "continuous";

    /**
     * The facing-pages behavior constant.
     */
    ...
    /**
     * The multi-part behavior constant.
     */
    static final String MULTI_PART = "multi-part";

    /**
     * The no-auto-advance behavior constant.
     */
    static final String NO_AUTO_ADVANCE = "no-auto-advance";

    /**
     * The no-nav behavior constant.
     */
    static final String NO_NAV = "no-nav";

    /**
     * The no-repeat behavior constant.
     */
    static final String NO_REPEAT = "no-repeat";

    /**
     * The non-paged behavior constant.
     */
    static final String NON_PAGED = "non-paged";

    /**
     * The paged behavior constant.
     */
    static final String PAGED = "paged";

    /**
     * The repeat behavior constant.
     */
    static final String REPEAT = "repeat";

    /**
     * The sequence behavior constant.
     */
    static final String SEQUENCE = "sequence";

    /**
     * The thumbnail-nav behavior constant.
     */
    static final String THUMBNAIL_NAV = "thumbnail-nav";

    /**
     * The together behavior constant.
     */
