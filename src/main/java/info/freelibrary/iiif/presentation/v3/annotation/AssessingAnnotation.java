...
public class AssessingAnnotation extends WebAnnotation {
    ...
    /**
     * Creates an assessing annotation from the supplied annotation ID and list of targets.
     *
     * @param aID An annotation ID
     * @param aTargetList A list of targets
     */
    public AssessingAnnotation(final String aID, final List<Target> aTargetList) {
    ...
    /**
     * Creates an assessing annotation from the supplied annotation ID and target array.
     *
     * @param aID An annotation ID
     * @param aTargetArray An array of targets
     */
    public AssessingAnnotation(final String aID, final Target... aTargetArray) {
    ...
    public final AssessingAnnotation setMotivation(final Motivation aMotivation) {
        if (!Purpose.ASSESSING.toString().equalsIgnoreCase(aMotivation.toString())) {
            throw new IllegalArgumentException(LOGGER.getMessage(MessageCodes.JPA_038,
                    AssessingAnnotation.class.getSimpleName(), Purpose.ASSESSING, aMotivation));
        }
