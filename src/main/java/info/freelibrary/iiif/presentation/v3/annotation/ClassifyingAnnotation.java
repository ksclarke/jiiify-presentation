...
public class ClassifyingAnnotation extends WebAnnotation {
    ...
    /**
     * Creates a classifying annotation from the supplied annotation ID and a list of targets.
     *
     * @param aID An annotation ID
     * @param aTargetList An annotation target list
     */
    public ClassifyingAnnotation(final String aID, final List<Target> aTargetList) {
    ...
    /**
     * Creates a classifying annotation from the supplied annotation ID and array of targets.
     *
     * @param aID An annotation ID
     * @param aTargetArray An array of annotation targets
     */
    public ClassifyingAnnotation(final String aID, final Target... aTargetArray) {
    ...
    public final ClassifyingAnnotation setMotivation(final Motivation aMotivation) {
        if (!Purpose.CLASSIFYING.toString().equalsIgnoreCase(aMotivation.toString())) {
            throw new IllegalArgumentException(LOGGER.getMessage(MessageCodes.JPA_038,
                    ClassifyingAnnotation.class.getSimpleName(), Purpose.CLASSIFYING, aMotivation));
        }
