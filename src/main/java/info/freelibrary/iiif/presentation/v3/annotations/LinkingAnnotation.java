...
public class LinkingAnnotation extends WebAnnotation implements Annotation<WebAnnotation> {
    ...
    @Override
    public LinkingAnnotation setBody(final List<ContentResource<?>> aBody) {
    ...
    @Override
    public LinkingAnnotation setTarget(final Target aTarget) {
        return (LinkingAnnotation) super.setTarget(aTarget);
    }
