...
import static info.freelibrary.iiif.presentation.properties.behaviors.BehaviorConstants.AUTO_ADVANCE;
import static info.freelibrary.iiif.presentation.properties.behaviors.BehaviorConstants.CONTINUOUS;
import static info.freelibrary.iiif.presentation.properties.behaviors.BehaviorConstants.FACING_PAGES;
import static info.freelibrary.iiif.presentation.properties.behaviors.BehaviorConstants.INDIVIDUALS;
import static info.freelibrary.iiif.presentation.properties.behaviors.BehaviorConstants.MULTI_PART;
import static info.freelibrary.iiif.presentation.properties.behaviors.BehaviorConstants.NON_PAGED;
import static info.freelibrary.iiif.presentation.properties.behaviors.BehaviorConstants.NO_AUTO_ADVANCE;
import static info.freelibrary.iiif.presentation.properties.behaviors.BehaviorConstants.NO_NAV;
import static info.freelibrary.iiif.presentation.properties.behaviors.BehaviorConstants.NO_REPEAT;
import static info.freelibrary.iiif.presentation.properties.behaviors.BehaviorConstants.PAGED;
import static info.freelibrary.iiif.presentation.properties.behaviors.BehaviorConstants.REPEAT;
import static info.freelibrary.iiif.presentation.properties.behaviors.BehaviorConstants.SEQUENCE;
import static info.freelibrary.iiif.presentation.properties.behaviors.BehaviorConstants.THUMBNAIL_NAV;
import static info.freelibrary.iiif.presentation.properties.behaviors.BehaviorConstants.TOGETHER;
import static info.freelibrary.iiif.presentation.properties.behaviors.BehaviorConstants.UNORDERED;
...
public class DisjointChecker {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(DisjointChecker.class, Constants.BUNDLE_NAME);
