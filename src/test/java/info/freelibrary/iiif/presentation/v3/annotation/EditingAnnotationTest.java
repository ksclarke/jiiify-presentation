...
public class EditingAnnotationTest {
    ...
    /**
     * Test method for {@link EditingAnnotation#EditingAnnotation(String, _Target)}.
     */
    @Test
    public final void testEditingAnnotationStringTarget() {
        assertTrue(new EditingAnnotation(ID_PATTERN + getRandom(), new Target(new Canvas(myMinter).getID())).getID()
                .startsWith(ID_PATTERN));
    }
