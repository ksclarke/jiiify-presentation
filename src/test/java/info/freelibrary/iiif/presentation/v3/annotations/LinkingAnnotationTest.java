...
public class LinkingAnnotationTest {
    ...
    /**
     * Test method for {@link LinkingAnnotation#LinkingAnnotation(String, Target)}.
     */
    @Test
    public final void testLinkingAnnotationStringTarget() {
        assertTrue(new LinkingAnnotation(ID_PATTERN + getRandom(), new Target(new Canvas(myMinter))).getID()
                .startsWith(ID_PATTERN));
    }
    ...
    public final void testSetMotivationMotivationBad() {
        assertTrue(new LinkingAnnotation(myMinter).setMotivation(Motivation.fromLabel(Purpose.ASSESSING)).getID()
                .startsWith(ID_PATTERN));
    }
}
