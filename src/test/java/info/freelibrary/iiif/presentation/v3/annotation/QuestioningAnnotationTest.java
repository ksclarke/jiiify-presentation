...
public class QuestioningAnnotationTest {
    ...
    /**
     * Test method for {@link QuestioningAnnotation#QuestioningAnnotation(String, _Target)}.
     */
    @Test
    public final void testQuestioningAnnotationStringTarget() {
        assertTrue(new QuestioningAnnotation(ID_PATTERN + getRandom(), new Target(new Canvas(myMinter).getID())).getID()
                .startsWith(ID_PATTERN));
    }
