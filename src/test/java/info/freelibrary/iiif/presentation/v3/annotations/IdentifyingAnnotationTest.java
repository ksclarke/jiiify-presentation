...
public class IdentifyingAnnotationTest {
    ...
    /**
     * Test method for {@link IdentifyingAnnotation#IdentifyingAnnotation(String, Target)}.
     */
    @Test
    public final void testIdentifyingAnnotationStringTarget() {
        assertTrue(new IdentifyingAnnotation(ID_PATTERN + getRandom(), new Target(new Canvas(myMinter))).getID()
                .startsWith(ID_PATTERN));
    }
