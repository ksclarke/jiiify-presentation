...
public class DescribingAnnotationTest {
    ...
    /**
     * Test method for {@link DescribingAnnotation#DescribingAnnotation(String, Target)}.
     */
    @Test
    public final void testDescribingAnnotationStringTarget() {
        assertTrue(new DescribingAnnotation(ID_PATTERN + getRandom(), new Target(new Canvas(myMinter))).getID()
                .startsWith(ID_PATTERN));
    }
