...
public class TaggingAnnotationTest {
    ...
    /**
     * Test method for {@link TaggingAnnotation#TaggingAnnotation(String, _Target)}.
     */
    @Test
    public final void testTaggingAnnotationStringTarget() {
        assertTrue(new TaggingAnnotation(ID_PATTERN + getRandom(), new Target(new Canvas(myMinter).getID())).getID()
                .startsWith(ID_PATTERN));
    }
