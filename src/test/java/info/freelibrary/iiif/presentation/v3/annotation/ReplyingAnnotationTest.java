...
public class ReplyingAnnotationTest {
    ...
    /**
     * Test method for {@link ReplyingAnnotation#ReplyingAnnotation(String, _Target)}.
     */
    @Test
    public final void testReplyingAnnotationStringTarget() {
        assertTrue(new ReplyingAnnotation(ID_PATTERN + getRandom(), new Target(new Canvas(myMinter).getID())).getID()
                .startsWith(ID_PATTERN));
    }
