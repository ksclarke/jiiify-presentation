...
public class CommentingAnnotationTest {
    ...
    /**
     * Test method for {@link CommentingAnnotation#CommentingAnnotation(String, _Target)}.
     */
    @Test
    public final void testCommentingAnnotationStringTarget() {
        assertTrue(new CommentingAnnotation(ID_PATTERN + getRandom(), new Target(new Canvas(myMinter).getID())).getID()
                .startsWith(ID_PATTERN));
    }
