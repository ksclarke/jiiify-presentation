...
public class BookmarkingAnnotationTest {
    ...
    /**
     * Test method for {@link BookmarkingAnnotation#BookmarkingAnnotation(String, _Target)}.
     */
    @Test
    public final void testBookmarkingAnnotationStringTarget() {
        assertTrue(new BookmarkingAnnotation(ID_PATTERN + getRandom(), new Target(new Canvas(myMinter).getID())).getID()
                .startsWith(ID_PATTERN));
    }
