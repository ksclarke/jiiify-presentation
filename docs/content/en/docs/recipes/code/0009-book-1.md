...
canvasList.forEach(canvasData -> {
  var canvas = new Canvas(minter, new Label("en", canvasData[0]));
  var imageContent = new ImageContent(canvasData[1]);
  var service = new ImageService3(LEVEL_ONE, canvasData[2]);
  var width = Integer.valueOf(canvasData[3]);
  var height = Integer.valueOf(canvasData[4]);
