...
List<String[]> data = Arrays.asList(
  new String[] { "Blank page", "https://iiif.io/api/image/3.0/example/reference/59d09e6773341f28ea166e9f3c1e674f-gallica_ark_12148_bpt6k1526005v_f18/full/max/0/default.jpg", "https://iiif.io/api/image/3.0/example/reference/59d09e6773341f28ea166e9f3c1e674f-gallica_ark_12148_bpt6k1526005v_f18", "3204", "4613" },
  new String[] { "Frontispiece", "https://iiif.io/api/image/3.0/example/reference/59d09e6773341f28ea166e9f3c1e674f-gallica_ark_12148_bpt6k1526005v_f19/full/max/0/default.jpg", "https://iiif.io/api/image/3.0/example/reference/59d09e6773341f28ea166e9f3c1e674f-gallica_ark_12148_bpt6k1526005v_f19", "3186", "4612" },
  new String[] { "Title page", "https://iiif.io/api/image/3.0/example/reference/59d09e6773341f28ea166e9f3c1e674f-gallica_ark_12148_bpt6k1526005v_f20/full/max/0/default.jpg", "https://iiif.io/api/image/3.0/example/reference/59d09e6773341f28ea166e9f3c1e674f-gallica_ark_12148_bpt6k1526005v_f20", "3204", "4613" },
  new String[] { "Blank page", "https://iiif.io/api/image/3.0/example/reference/59d09e6773341f28ea166e9f3c1e674f-gallica_ark_12148_bpt6k1526005v_f21/full/max/0/default.jpg", "https://iiif.io/api/image/3.0/example/reference/59d09e6773341f28ea166e9f3c1e674f-gallica_ark_12148_bpt6k1526005v_f21", "3174", "4578" },
  new String[] { "Bookplate", "https://iiif.io/api/image/3.0/example/reference/59d09e6773341f28ea166e9f3c1e674f-gallica_ark_12148_bpt6k1526005v_f22/full/max/0/default.jpg", "https://iiif.io/api/image/3.0/example/reference/59d09e6773341f28ea166e9f3c1e674f-gallica_ark_12148_bpt6k1526005v_f22", "3198", "4632" } //
);

data.forEach(array -> {
  var canvas = new Canvas(minter, new Label("en", array[0]));
  var imageContent = new ImageContent(array[1]);
  var service = new ImageService3(LEVEL_ONE, array[2]);
  var width = Integer.valueOf(array[3]);
  var height = Integer.valueOf(array[4]);
...
The third method will create the manifest, but also assumes the data is coming from a spreadsheet instead of being all hard-coded. It uses a loop to construct the 
manifest's resources. Unlike the other examples, it does not use a minter, but uses the same IDs as are found in the cookbook recipe.
...
for (int index = 0; index < pageList.size(); index++) {
  var pageData = pageList.get(index);
  ...
  var imageContent = new ImageContent(pageData[1]);
  var service = new ImageService3(LEVEL_ONE, pageData[2]);
  var width = Integer.valueOf(pageData[3]);
  var height = Integer.valueOf(pageData[4]);
